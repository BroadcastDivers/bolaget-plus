...
// const RATING_CONTAINER_ID = 'rating-container-body';
...
//   if (document.getElementById(RATING_CONTAINER_ID)) {
//     return;
//   }
...
//   bodyDiv.id = RATING_CONTAINER_ID;
...
//   const ratingContainer = document.getElementById(RATING_CONTAINER_ID);
//   if (!ratingContainer) {
//     return;
//   }
...
//   let container = document.getElementById(RATING_CONTAINER_ID);
//   if (!container) {
//     injectRatingContainer();
//   }
//   container = document.getElementById(RATING_CONTAINER_ID) as HTMLElement;
//   container.innerHTML = '';
//   return container;
// }
